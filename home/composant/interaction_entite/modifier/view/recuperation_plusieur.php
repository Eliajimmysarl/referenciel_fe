		...
		<table class="table table-bordered datatable" id="table-1">
			...
			<tbody>
				...
				echo"                         
					...
					<a href='?page=recuperation_un_interaction_entite&id=". $interaction_entites[$i]->id ."'  class='btn btn-default btn-sm btn-icon icon-left'><i class='entypo-info'></i>Detail</a></td>
				</tr>";
