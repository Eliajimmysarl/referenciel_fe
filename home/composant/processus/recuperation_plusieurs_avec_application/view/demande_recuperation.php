	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=recuperation_avec_application_processus"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
