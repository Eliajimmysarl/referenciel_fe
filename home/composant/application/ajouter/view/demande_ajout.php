					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Lien web <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="lien_web" class="form-control" placeholder="le lien web" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Lien android <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="lien_android" class="form-control" placeholder="le lien endroid" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Lien ios <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="lien_ios" class="form-control" placeholder="le lien ios" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Ussd vodacom <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="ussd_vodacom" class="form-control" placeholder="l'ussd vodacom" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Ussd africel <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="ussd_africell" class="form-control" placeholder="l'ussd africell" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Ussd orange <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="ussd_orange" class="form-control" placeholder="l'ussd orange" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
